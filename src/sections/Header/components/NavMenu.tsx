...
export const NavMenu = ({ isOpen, toggle, mobile, onItemClick }: NavMenuProps) => {
    ...
    const subItemsTinnen = [
        { label: 'Unsere Kirche', link: '/tinnen/kirche' },
    ];

    const subItemsWesuwe = [
        { label: 'Unsere Kirche', link: '/wesuwe/kirche' },
    ];

    const subItemsAltharen = [
        { label: 'Unsere Kirche', link: '/altharen/kirche' },
    ];

    const subItemsHaren = [
        { label: 'Unsere Kirche', link: '/haren/kirche' },
    ];
...
console.log(menuItems)
    ...
    return (
        ...
        >
            {menuItems.map((item) => (
                <NavElement label={item.label} key={item.key} isOpen={isOpen} toggle={toggle} route={item.route} subMenuItems={item.subMenuItems} />
            ))}
